...
namespace CAPP.Infrastructure.Persistence
{
    public static class ApplicationDbContextSeed
    {
        public static async Task SeedDefaultData(ApplicationDbContext context)
        {
            ...
            context.Database.ExecuteSqlRaw("SET IDENTITY_INSERT [dbo].[OperationGroups] ON");

            if (!context.OperationGroups.Any()) 
            {                
            ...
            context.Database.ExecuteSqlRaw("SET IDENTITY_INSERT [dbo].[OperationGroups] OFF");
            context.Database.CommitTransaction();

            context.Database.BeginTransaction();
            context.Database.ExecuteSqlRaw("SET IDENTITY_INSERT [dbo].[Operations] ON");
            ...
            context.Database.ExecuteSqlRaw("SET IDENTITY_INSERT [dbo].[Operations] OFF");
            context.Database.CommitTransaction();

            context.Database.BeginTransaction();
            context.Database.ExecuteSqlRaw("SET IDENTITY_INSERT [dbo].[OperationObjects] ON");
            if (!context.OperationObjects.Any())
            {
            ...
            context.Database.ExecuteSqlRaw("SET IDENTITY_INSERT [dbo].[OperationObjects] OFF");
            context.Database.CommitTransaction();
        }
    }
}
